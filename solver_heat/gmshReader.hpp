...
//                }
    ...
    void writeGeometryInput(const string outFileName ,variables var)
    {
        // ------------
        // *** HDF5 *** 
        // ------------

        File file(outFileName+".h5", File::ReadWrite | File::Truncate);
        ...
        // *** XDMF ***
        // ------------
        string fnameXDMF = outFileName + ".xmf";
